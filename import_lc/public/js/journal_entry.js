frappe.ui.form.on("Journal Entry", {
	refresh: function (frm) {
		...
		if (frm.is_new() && frm.doc.import_lc && (frm.doc.voucher_type === "Journal Entry" || !frm.doc.voucher_type)) {
	...
	import_lc: function (frm) {
		if (frm.doc.import_lc && (frm.doc.voucher_type === "Journal Entry" || !frm.doc.voucher_type)) {
			frm.set_value("voucher_type", "LC Margin");
		}
		fetch_lc_data(frm);
	},
...
var calculate_margin_amount = function (frm) {
	if (frm.doc.voucher_type === "LC Margin" && frm.doc.lc_margin !== undefined && frm.doc.import_lc_amount !== undefined) {
